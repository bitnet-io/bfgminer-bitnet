...
#ifdef USE_AURUM
#define AURUM_MAXBUFFERS (0x100)
#define AURUM_BUFFERSIZE (sizeof(uint32_t) * AURUM_MAXBUFFERS)
#define AURUM_FOUND (0xFF)
#define OPENCL_MAX_BUFFERSIZE  AURUM_BUFFERSIZE   
#else
#define OPENCL_MAX_BUFFERSIZE  BUFFERSIZE
#endif
