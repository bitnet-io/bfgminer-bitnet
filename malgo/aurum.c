...
struct mining_algorithm malgo_aurum = {
        .name = "aurum",
        .aliases = "aurum",
        ...
        .hash_data_f = aurum_hash_data,
        
#ifdef USE_OPENCL
        .opencl_nodefault = true,
        .opencl_oclthreads_to_intensity = opencl_oclthreads_to_intensity_aurum,
        .opencl_intensity_to_oclthreads = opencl_intensity_to_oclthreads_aurum,
        .opencl_min_oclthreads =      0x100,  // intensity   8
        .opencl_max_oclthreads = 0x20000000,  // intensity  31
        .opencl_min_nonce_diff = 1./0x10000,
        .opencl_get_default_kernel_file = opencl_get_default_kernel_file_aurum,
#endif
};

static
__attribute__((constructor))
void init_aurum(void)
{
        LL_APPEND(mining_algorithms, (&malgo_aurum));
}
