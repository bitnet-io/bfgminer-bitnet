WORK IN PROGRESS THIS DOES NOT FUNCTION OR BUILD JUST A PROTOTYPE THAT starts to build


```
git clone https://github.com/bitnet-io/bfgminer-bitnet
cd bfgminer-bitnet
sh autogen.sh

then grab this file and unzip........
https://github.com/bitnet-io/bfgminer-bitnet/releases/tag/opencl
tar -xvf https://github.com/ghostlander/AMD-APP-SDK/releases/download/v2.9.1/AMD-APP-SDK-v2.9.1-lnx64.tar.xz
...
make -j4    # for 4 cores use 16 cores or 24 cores for faster builds when you have more threads

make -j4 install

binaries will be in bfgminer-binaries/bin
